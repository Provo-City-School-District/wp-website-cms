<aside id="mainSidebar">
	...
	?>
		<section>
			...
			<input type="text" name="dsearch" class="text-input" aria-labelledby="directorySearch" id="sidebar-filter" value="" placeholder="<?php if (is_page($post = '42740')) {
																																					echo 'Search Administration & Main Office';
																																				} elseif (is_page($post = '42744')) {
																																					echo 'Search Counseling Staff';
																																				} elseif (is_page($post = '42742')) {
																																					echo 'Search Teachers';
																																				} else {
																																					echo 'Search our Staff...';
																																				} ?>" />
